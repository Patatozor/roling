<h1>Caractéristiques de personnage</h1>

<div class="bloc">
	<div class="row margin-bottom">
		<div class="col-sm-12">
			<h2>Caractéristiques Majeures:</h2>
			<p>
				Les caractéristiques majeures représentent les aptitudes générales de votre personnage. Elles sont définies lors de la création du personnage et resteront figées pendant toutes les aventures du personnage, certaines compétences, objets et races permettent cependant d'avoir des bonus sur ces caractéristiques. 
			</p>
			<p>
	...
	<div class="row margin-bottom">
		<table class="border-on col-sm-4">
			<thead>
				<th colspan="2"><span class="table-title">Valeurs et modificateurs de caractéristiques</span></th>
			</thead>
			<tr>
				<th>Valeur</th>
				<th>Mod.</th>
	...
	<div class="row">
		...
		<ul>
			...
			<li><b>Les Points de magie (PM)</b> représente les réserves magiques de votre personnage pour lancer des sortilèges. Le personnage commence avec <b>[Mod de VOL + Mod d'INT + nombre dépendant du profil/classe joué]</b> </li>
			<li><b>Les Points de compétence (PC)</b> représente l'expérience acquise dans l'apprentissage de nouvelles compétences. Vous pouvez donc les utiliser pour apprendre de nouvelles compétences en payant le coût d'apprentissage. Un personnage commence avec <b>[valeur d'INT divisé par deux]</b> PC (arrondi à la valeur inférieure)</li>
